  ...
  <!--Container for ALL content, everything inside this--><div class="container">
    ...
    <!--Row begins--><div class="row">
      ...
      <!--Content begins #content--><div class="twelve columns nomargin" id="content">
        ...
        <div class="six columns" style="background: black; color: white;">
          ...
          <div class="six columns" style="background: orange; color: white;">
            <h2><?php perch_content('Link to EYFS document'); ?>Learn about Early Years Foundation Stage</h2>
          </div>

          <div class="five columns" style="background: purple; color: white;">
            <p><a href="<?php perch_content('Link to MCI'); ?>">Montessori Centre International</a></p>
          </div>
        </div>

        <div class="five columns" style="background: black; color: white;">
