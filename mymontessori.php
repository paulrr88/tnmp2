  ...
  <!--Container for ALL content, everything inside this--><div class="container">
    ...
    <!--Row begins--><div class="row">
      ...
      <a href="../mymontessorichild/">MMC</a>
        ...
        <h2><a href="https://www.mymontessorichild.com/parents/">Click here to log in to My Montessori Child</a></h2>

        <p>For more information on how we handle your child's information, please see the appropriate documents from <a href="">Our Policies</a>:</p>

        <ul class="compact">
          <li><a href="../docs/new-montessori-mmc.pdf">My Montessori Child Policy (PDF)</a></li>
