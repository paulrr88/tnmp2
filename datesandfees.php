  ...
  <!--Container for ALL content, everything inside this--><div class="container">
    ...
    <!--Row begins--><div class="row">
      ...
      <!--Content begins #content--><div class="twelve columns nomargin" id="content">
        ...
        <p>Once our pre-school receives your child registration form we offer our parents <strong>four free settling in visits</strong> for your child to ensure the transition goes smoothly.</p>
        ...
        <h2 class="title less-space-bottom width-small pretty-purple">Payments and Information on WSCC Funding</h2>
