    ...
    <!--Row begins--><div class="row">
      ...
      <!--Content begins #content--><div class="twelve columns nomargin" id="content">
        ...
        <ul class="body">
          ...
          <li><strong>Introduce new families into the group on a staggered basis</strong>, for example two new children each day for a week rather than ten new children all at once.</li>
        </ul>

        <p>Children cannot play or learn successfully if they are anxious and unhappy. <strong>Our settling procedures aim to help parents to help their children to feel comfortable in the pre-school</strong>, to benefit from what it has to offer, and to be confident that their parents will return at the end of the session.</p>
